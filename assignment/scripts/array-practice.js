...
let favoriteFoods = ['pasta', 'rice', 'anjera'];
console.log('My favourite foods are: ', favoriteFoods);
...
console.log("my number of foods :" , numberOfFoods)
...
let sortedArray = gems.sort().reverse();
